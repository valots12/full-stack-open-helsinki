...
describe('total likes', () => {
  ...
  test('when list has more blogs, equals the sum of the likes', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has no blogs, empty result', () => {
    const result = listHelper.favoriteBlog(listWithNoBlog)
    expect(result).toEqual({})
  })

  test('when list has only one blog, equals the description of that', () => {
  ...
  test('when list has more blogs, equals the description of the most popular', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, equals the author and the number', () => {
  ...
  test('when list has more blogs, equals the author and the max number of blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has more blogs, equals the author and the sum of likes', () => {
